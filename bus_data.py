bus_data = [
    ...
    # Pokhara to Kathmandu Route
    {
    ...
    },
     {
        "bus_number": "GA 1 KH 9012",
        "bus_model": "Scania K410",
        "service_company": "ABC Yatayat",
        "driver_name": "Hari Tamang",
        "route": {"start": "Pokhara", "end": "Kathmandu"},
        "seat_capacity": 35,
        "seat_available": 28,
        "ac": True,
    ...
    },
     {
        "bus_number": "GA 1 KH 9012",
        "bus_model": "Scania K410",
        "service_company": "Mountain Yatayat",
        "driver_name": "Bipin Rai",
        "route": {"start": "Pokhara", "end": "Kathmandu"},
        "seat_capacity": 35,
        "seat_available": 28,
        "ac": True,
    ...
    },
    {
        "bus_number": "BA 4 KH 7890",
        "bus_model": "Scania K360",
        "service_company": "Smart Yatru",
        "driver_name": "Krisya Shreshtha",
        "route": {"start": "Kathmandu", "end": "Biratnagar"},
        "seat_capacity": 38,
        "seat_available": 30,
        "ac": True,
    ...
    # Kathmandu to  Sikkim
    {
        "bus_number": "BA 6 KH 4544",
        "bus_model": "Volvo K360",
        "service_company": "Sikkim Express",
        "driver_name": "Haji Poudel",
        ...
        {
        "bus_number": "BA 6 KH 4544",
        "bus_model": "Mercedes B32",
        "service_company": "All Rounder",
        "driver_name": "Haji Poudel",
        "route": {"start": "Kathmandu", "end": "Sikkim"},
        "seat_capacity": 38,
        "seat_available": 33,
